...
class AINewsNode:
    ...
    def fetch_news(self, state: dict) -> dict:
        """
        Fetch Liverpool FC news based on the specified frequency.
        ...
        response = self.tavily.search(
            ...
            # include_domains=["liverpoolfc.com", "bbc.com/sport/football", "skysports.com", ...]  # Uncomment and add domains if needed
        )
    ...
    def summarize_news(self, state: dict) -> dict:
        ...
        prompt_template = ChatPromptTemplate.from_messages([
            ("system", """Summarize Liverpool FC news articles into markdown format. For each item include:
    ...
    def save_result(self, state):
        ...
        filename = f"./md/{frequency}_summary.md"
